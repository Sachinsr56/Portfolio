...
const Skills = () => {
  return (
    <div id="Skills" className="skills-section">
      ...
      <p className="xyz">
        I love to work on real world application projects where I use my Web
        Development,
        <br /> Data Cleaning and structured coding skills.
      </p>
      <div className="container">
        <div className="row">
          ...
          <div className="card col-md-4 col-sm-12">
            <div className="percent" style={{ "--clr": "Tomato", "--num": 85 }}>
              <div className="dot"></div>
              <svg>
                <circle cx="70" cy="70" r="70"></circle>
                <circle cx="70" cy="70" r="70"></circle>
